...
namespace EmsMVC.HtmlHelpers
{
    public class CustomValidation : ValidationAttribute, IClientValidatable
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the CustomValidation class
        /// </summary>
        ...
        public CustomValidation(string dependentProperty, params object[] targetValue)
        {
