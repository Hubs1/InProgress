...
{
    public class NameRequiredAttribute:ValidationAttribute
    {
        //public override bool IsValid(object value)
        //{
        //    EmployeeEntities employee = new EmployeeEntities();
        //    value = employee.AddressType;
        //    AddressEntity address = new AddressEntity();
        //    try
        //    {
        //        int type = (int)value;
        //        if (address.GetAddress.AddressType == 0)
        //            return true;
        //    }
        //    catch (Exception)
        //    {
        ...
        public NameRequiredAttribute(String propertyName, Object desiredvalue)
        {
