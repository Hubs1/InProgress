...
{
    [Authorize]
    //replace Account to AccountController in current document
    public class Account : Controller
    {
        ...
        private ZiorEntities db = new ZiorEntities();// create database private variable(update user name and password)
        //
        // GET: /Account/Login
        [AllowAnonymous]
